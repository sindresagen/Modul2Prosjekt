    ...
    let picturePage = `
                             <div class="picture-page"> 
                                <button class="buttonPic" 
                                        onclick="picturePgView()">STORFE</button>
    ...
    let quizPage = `
                    ...
                    <div class="picture-page"> 
                            ...
                            <div id="cow" style="text-align: center"><img src="images/ku2.png" width="1132" height"676" alt="heileKua" usemap="#cowMap">
                                <map id="cowMap" name="cowMap">
                                <h2 class="chuck-txt "
                                    onclick="quizPgInfo(1); randomCut('chuckQuiz', 1)">${model.quiz[1].ifTrue}</h2>
                                <area class="chuck"
                                      shape="poly" 
                                      coords="260,55, 253,90, 280,300, 445,300, 440,100 " 
                                      alt="chuck" 
                                ...
                                <h2 class="rib-txt "
                                    onclick="quizPgInfo(0); randomCut('ribQuiz', 0)">${model.quiz[0].ifTrue}</h2>
                                <area class="rib" 
                                      shape="poly" 
                                      coords="450,100, 460,297, 666,298, 675,185, 655,104, 558,109" 
                                      alt="rib"
                                ...
                                <h2 class="brisket-txt "
                                    onclick="quizPgInfo(2); randomCut('brisketQuiz', 2)">${model.quiz[2].ifTrue}</h2>
                                <area class="brisket" 
                                      shape="poly" 
                                      coords="295,318, 333,400, 445,403, 450,312" 
                                      alt="brisket"                                      
                                ...
                                <h2 class="plate-txt "
                                      onclick="quizPgInfo(3); randomCut('plateQuiz', 3)">${model.quiz[3].ifTrue}</h2>
                                <area class="plate" 
                                      shape="poly" 
                                      coords="458,309, 460,403, 660,388, 657,340, 660,312" 
                                      alt="plate"                                        
                                ...
                                <h2 class="shortloin-txt "
                                      onclick="quizPgInfo(11); randomCut('shortloinQuiz', 11)">${model.quiz[11].ifTrue}</h2>
                                <area class="shortloin" 
                                      shape="poly" 
                                      coords="670,103, 685,168, 689,231, 675,297, 805,315, 820,254, 815,173, 700,172, 730,152, 805,135, 793,89" 
                                      alt="shortloin"                                       
                                ...
                                <h2 class="sirloin-txt "
                                      onclick="quizPgInfo(4); randomCut('sirloinQuiz', 4)">${model.quiz[4].ifTrue}</h2>
                                <area class="sirloin" 
                                      shape="poly" 
                                      coords="800,87, 810,134, 900,119, 918,106, 907,73" 
                                ...
                                <h2 class="tenderloin-txt "
                                      onclick="quizPgInfo(6); randomCut('tenderloinQuiz', 6)">${model.quiz[6].ifTrue}</h2>
                                <area class="tenderloin" 
                                      shape="poly" 
                                      coords="720,167, 800,146, 881,132, 920,120, 930,150, 830,165" 
                                      alt="tenderloin"                                       
                                ...
                                <h2 class="topsirloin-txt "
                                      onclick="quizPgInfo(5); randomCut('topsirloinQuiz', 5)">${model.quiz[5].ifTrue}</h2>
                                <area class="topSirloin" 
                                      shape="poly" 
                                      coords="823,173, 825,200, 925,198, 942,203, 933,159" 
                                      alt="topSirloin"                                        
                                      style="cursor: pointer" 
                                      onclick="quizPgInfo(5); randomCut('topsirloinQuiz', 5)">
                                <h2 class="bottomsirloin-txt "
                                      onclick="quizPgInfo(8); randomCut('bottomsirloinQuiz', 8)">${model.quiz[8].ifTrue} Sirloin</h2>
                                <area class="bottomSirloin" 
                                      shape="poly" 
                                      coords="826,208, 826,257, 822,288, 813,317, 900,343, 925,355, 937,360, 947,296, 942,214, " 
                                      alt="bottomSirloin"                                      
                                ...
                                <h2 class="flank-txt "
                                      onclick="quizPgInfo(7); randomCut('flankQuiz', 7)">${model.quiz[7].ifTrue}</h2>
                                <area class="flank" 
                                      shape="poly" 
                                      coords="672,310, 668,347, 673,386, 832,374, 912,359, 861,336" 
                                      alt="flank"                                       
                                ...
                                <h2 class="rounds-txt "
                                      onclick="quizPgInfo(9); randomCut('roundsQuiz', 9)">${model.quiz[9].ifTrue}</h2>
                                <area class="round" 
                                      shape="poly" 
                                      coords="916,75, 951,197, 958,280, 954,321, 948,359, 1040,359, 1069,275, 1073,177, 1047,91, 1050,54" 
                                      alt="round" 
                                ...
                                <h2 class="shankR-txt"
                                      onclick="quizPgInfo(10); randomCut('shankQuiz', 10)"> ${model.quiz[10].ifTrue}</h2>
                                <area class="shankR" 
                                      shape="poly" 
                                      coords="925,370, 995,446, 1050,450, 1045,367" 
                                      alt="shankR"                                    
