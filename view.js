...
function listPgInfo(i){
    const listInfo = document.getElementById("list-info") || document.getElementById("pic-info");
    const cut = model.cuts[i];
    listInfo.innerHTML = `
    <h1>${cut.name}</h1>
...
function picturePgView(){
    let picturePage = `
                            ...
                            <div id="cow" style="text-align: center"><img src="images/ku2.png" width="1132" height"676" alt="heileKua" usemap="#cowMap">
                                ...
                                <area class="chuck" shape="poly" coords="260,55, 253,90, 280,300, 445,300, 440,100 " alt="chuck" target="_blank" onclick="listPgInfo(1)">
