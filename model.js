...
const model = { 
    cuts: [
        ...
        { animal: 'Chicken', cut: 'Breast', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808316636418801704/chick-breast.jpg' },
        { animal: 'Chicken', cut: 'Back', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808316652961267712/Chicken-Back.jpg' },
        { animal: 'Chicken', cut: 'Leg', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808316669734158336/chick-leg.jpg' },
        { animal: 'Chicken', cut: 'Neck', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808316685706330152/chick-neck.jpg' },
        { animal: 'Chicken', cut: 'Thigh', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808316707780952084/chick-thigh.jpg' },
        { animal: 'Chicken', cut: 'Wings', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808316728169857024/chick-wings.jpg' },
        
        { animal: 'Pork', name: 'Head', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808281865492496424/PorkHead.jpg' },
        { animal: 'Pork', name: 'Blade shoulder', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808281988246274058/Pork-shoulder.jpg' },
        { animal: 'Pork', name: 'Arm shoulder', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808281833489956914/Pork-arm.jpg' },
        { animal: 'Pork', name: 'Loin', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808281931799330816/Pork-Loin-Chop.jpg' },
        { animal: 'Pork', name: 'Spare rib', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808282031292416000/Pork-Spare-Ribs.jpg' },
        { animal: 'Pork', name: 'Side', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808282003216138240/Pork-side.jpg' },
        { animal: 'Pork', name: 'Leg', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808281908520943676/pork-leg.png' },
        { animal: 'Pork', name: 'Hock', chosen:"defaultChosen", use: '', info: '', picture: 'https://media.discordapp.net/attachments/796668478261297152/808281888849526804/Pork-hock.PNG' },
    ],
    chosenAnimal: "Cattle",
    question:  "dafuk dis?",
    choices: [],
