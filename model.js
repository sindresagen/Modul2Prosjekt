...
const model = { 
    cuts: [
        { animal: 'Cattle', name: 'Rib', use: 'Grilles ofte, tenk spare-ribs, short rib, prime rib og rib-eye-stek.', info: 'Tilsvarer tynnribbe på svin', picture: 'https://media.discordapp.net/attachments/796668478261297152/806828549612240896/rib.jpg?width=492&height=676' },
        ...
        { animal: 'Cattle', name: 'Plate', use: 'Brukes til grytesteking, "skirt steak" brukes i fajitas, det resterende kjøttet blir oppmalt.', info: 'Bibringe, brystbein skåret på tvers.', picture: 'https://media.discordapp.net/attachments/796668478261297152/806828546634285066/plate.jpg' },
        ...
        { animal: 'Cattle', name: 'Tenderloin', use: 'Kan stekes som det er, brukes i steker som beef wellington.', info: 'Indrefilet, dette er det møreste kjøttet, kan kuttes videre til filet mignon, tournedos eller indrefilet.', picture: 'https://media.discordapp.net/attachments/796668478261297152/806830641173495818/tenderloin.jpeg?width=1013&height=676' },
        { animal: 'Cattle', name: 'Flank', use: 'Brukes mest til kverning, unntatt for den lange og flate flank steak(flankestek/slagside) best kjent som ingrediensen i London broil, og "inside skirt steak" brukes også til fajitas.', info: 'Flankestek; slagside.', picture: 'https://media.discordapp.net/attachments/796668478261297152/806828545740898354/flank.jpg?width=1014&height=676' },
        { animal: 'Cattle', name: 'Bottom sirloin', use: 'Kjøttet brukes ofte til å tilberede tri-tip og klaff biff.', info: 'Den nederste mørbradbiffen er en biff kuttet fra baksiden av dyret under øverste mørbrad og over flanken. Kjøttet regnes som magert og seigt.', picture: 'https://media.discordapp.net/attachments/796668478261297152/806828536844255252/Bottomsirloin.jpg' },
